    ...
    for i in 0..vector_len {
        ...
        if dec_count_for_versions == 0 {
            ...
            for j in 0..xmin_vec.len() {
                ...
                // TODO: 0 is placeholder. Add VID to serialization format and update all of it.
                ver_vec.push(Version { value: values_vec[j].clone(), xmin: xmin_vec[j] as u32, xmax: Some(xmax_vec[j] as u32), version_info: VersionInfo {version_status: VersionStatus::Active, vid: 0} }); 
            }
            values_vec.clear();
            xmin_vec.clear();
            xmax_vec.clear();
